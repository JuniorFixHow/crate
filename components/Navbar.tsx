...
const Navbar = () => {
  ...
  return (
    <div className={`flex xl:p-4 z-20 min-h-full absolute xl:relative dark:border-r border-slate-200  lg:flex flex-col gap-6 ${toggle? 'pt-4':'p-4'} bg-white dark:bg-[#0F1214] shadow-xl rounded-lg`} >
