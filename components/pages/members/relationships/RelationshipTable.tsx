...
import { SearchRelationship } from "./fxn";
          ...
          <div className="flex w-full">
            {
                ...
                <Paper className='w-full' sx={{ height: 480, }}>
                    <DataGrid
                        rows={SearchRelationship(relationships!, churchId, search)}
                        columns={RelationshipColumns(handleEdit, hadndleInfo,  hadndleDelete)}
