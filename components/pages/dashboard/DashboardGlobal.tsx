...
import SearchSelectVendorsV2 from '@/components/features/SearchSelectVendorsV2'
import { checkIfAdmin } from '@/components/Dummy/contants'
import {  isChurchAdmin } from '@/components/auth/permission/permission'
    ...
    <div {...props}  className={`${className} flex-col gap-8`} >
      <div className='flex flow-row w-full items-start gap-4'>
        ...
        <div className="flex flex-row  gap-4 items-start">
          ...
          {
            (isAdmin || isChurchAdmin.reader(user)) &&
            <div className="hidden lg:flex flex-col gap-[0.5rem]">
              ...
              <SearchSelectVendorsV2 width={200} setSelect={setVendorId} />
              {
                statsLoading ?
