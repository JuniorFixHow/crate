...
const Reset = () => {
  ...
  return (
    <div className='h-screen w-full flex bg-[url(/bg.jpg)] relative items-center justify-center overflow-hidden' >
        ...
        <div className="flex flex-col items-center z-10 dark:bg-[#0F1214] bg-white pt-4 rounded">
            ...
            <form onSubmit={resetRequest}  className='w-[90%] md:w-[24rem]  rounded-lg shadow-xl p-16 flex flex-col gap-4 items-center' >
              <div className="flex relative flex-row gap-4 items-start w-full">
                ...
                <div className="flex flex-col gap-1">
                  <span className='text-xl font-bold dark:text-white' >Forgot Password?</span>
                ...
                <div className="flex w-full gap-8 flex-col">
                    <div className="flex flex-col w-full">
                        ...
                        <input required onChange={(e)=>setEmail(e.target.value)} type="email" name="email" className='outline-none border-b border-b-slate-200 px-1' />
                    </div>
